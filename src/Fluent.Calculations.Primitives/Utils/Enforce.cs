...
{
    public static T NotNull<T>(T? condition, [CallerMemberName] string argumentName = StringConstants.NaN)  where T : IValue => condition ?? throw new ArgumentNullException(argumentName);
